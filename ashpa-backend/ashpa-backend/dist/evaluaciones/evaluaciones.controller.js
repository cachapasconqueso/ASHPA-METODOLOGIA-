...
const intento_dto_1 = require("./dto/intento.dto");
...
let EvaluacionesController = class EvaluacionesController {
    ...
    obtenerPorModulo(moduloId) {
        return this.evaluacionesService.obtenerPorModulo(moduloId);
    }
    registrarIntento(moduloId, dto, req) {
...
__decorate([
    (0, common_1.Get)(':moduloId'),
    __param(0, (0, common_1.Param)('moduloId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], EvaluacionesController.prototype, "obtenerPorModulo", null);
__decorate([
    (0, common_1.Post)(':moduloId/intento'),
    __param(0, (0, common_1.Param)('moduloId')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, intento_dto_1.IntentoDto, Object]),
    __metadata("design:returntype", void 0)
], EvaluacionesController.prototype, "registrarIntento", null);
